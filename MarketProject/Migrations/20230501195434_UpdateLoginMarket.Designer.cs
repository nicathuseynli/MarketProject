...
namespace MarketProject.Migrations
{
    ...
    [Migration("20230501195434_UpdateLoginMarket")]
    partial class UpdateLoginMarket
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MarketProject.Datas.Entities.AppUser", b =>
                {
            ...
            modelBuilder.Entity("MarketProject.Datas.Entities.TypeWarehouse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MarketProject.Datas.Entities.TypeWarehouse", b =>
                {
                    b.HasOne("MarketProject.Datas.Entities.TypeWarehouse", null)
                        .WithMany("TypeWarehouses")
            ...
            modelBuilder.Entity("MarketProject.Datas.Entities.Warehouse", b =>
                {
                    ...
                    b.HasOne("MarketProject.Datas.Entities.TypeWarehouse", "TypeWarehouse")
                        .WithMany()
                        .HasForeignKey("TypeWarehouseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MarketProject.Datas.Entities.AppUser", null)
                        .WithMany()
